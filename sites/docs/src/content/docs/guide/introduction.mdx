...
You might be wondering where the name **Cuek** comes from. It actually started with the word **Lean**. We wanted something that described the philosophy of the library, but "Lean" is a generic word that has been used by every mediocre startup since 2012.

We wanted something sharper. **Cuek** sounds Japanese, looks cool on a sticker, and stays true to the "Lean" roots without the corporate baggage.
